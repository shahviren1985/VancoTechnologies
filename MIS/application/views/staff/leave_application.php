					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<?php if($staff_details[0]->casual_leave_balance == 0 && $staff_details[0]->sick_leave_balance == 0 && $staff_details[0]->paid_leave_balance == 0){
								...
								<form class="grid_form" method="post" id="leave_form" action="<?php echo base_url('leaveSubmit'); ?>" enctype="multipart/form-data">
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label for="type" class="control-label">Leave Type</label>
													<select name="leave_type" data-rule-required="true" id="leave_type" class="form-control" aria-required="true">
														<option value="">---Select Leave Type---</option>
														<option value="Casual-Leave" data-value="<?php echo $staff_details[0]->casual_leave_balance; ?>" <?php if($staff_details[0]->casual_leave_balance == 0){echo 'disabled';}else{ } ?>>
															Casual Leave
														</option>
														<option value="Sick-Leave" data-value="<?php echo $staff_details[0]->sick_leave_balance; ?>" <?php if($staff_details[0]->sick_leave_balance == 0){echo 'disabled';}else{} ?>>
															Sick Leave
														</option>
														<option value="Paid-Leave" data-value="<?php echo $staff_details[0]->paid_leave_balance; ?>">
															Paid Leave
														</option>
														<option value="Unpaid-Leave" data-value="<?php echo $staff_details[0]->casual_leave_balance; ?>">
															Unpaid Leave
														</option>

													<?php if($staff_details[0]->role=="Teaching Staff"){ ?>
														<option value="Half-Day-Leave" data-value="<?php echo $staff_details[0]->casual_leave_balance; ?>">
															Half Pay Leave
														</option>
													<?php } ?>
													
														<option value="Compensate-Leave" data-value="<?php echo $staff_details[0]->casual_leave_balance; ?>">
															Compensatory Leave
														</option>
													</select>
											</div>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group"> 
												<label for="leave_from" class="control-label">
													<span id="datefrom">From</span> </label>
												<input type="text" class="form-control" name="leave_from" id="leave_from" placeholder="Leave From" autocomplete="off" />
											</div>
										</div>
										<div class="col-md-6" id="ToDate">
											<div class="form-group"> 
												<label for="leave_to" class="control-label">To</label>
												<input type="text" class="form-control" name="leave_to" id="leave_to" placeholder="Leave To" autocomplete="off"/>
											</div>
										</div>
									</div>
										...
										<div class="col-md-6">
											<div class="form-group"> 
												<div class="staff_detail">
													<input type="radio" class="" id="leave_for" name="leave_for" value="Half-Day"/>
									...
									<div class="row" id="leave_docDiv" style="display: none;">
										<div class="col-md-12">
											<div class="form-group">
												<label for="leave_doc" class="control-label">Leave Document</label>
												<input type="file" class="form-control" name="leave_doc" id="leave_doc" data-rule-required="true" aria-required="true">
											</div>
										</div>
									</div>
									<div class="row">
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<?php if(!empty($leave_request)){
								...
								$leave_doc = $leave_request[1]->leave_doc;
						...
						?>
							<form class="grid_form" method="post" id="view_leave_detail">
								<div class="row">	
									...
									<?php if(!empty($leave_doc)){ ?>	
									<div class="col-md-6">
										<div class="form-group">
											<label for="leave_hand_given" class="control-label">Leave Document</label>
											<a href="<?php echo base_url('uploads/leave_documents/'.$leave_doc);?>" target="_blank"> <?php echo $leave_doc;?></a>
