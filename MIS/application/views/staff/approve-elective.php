	...
	<div class="container-fluid">
		...
		<div class="card1">
			...
			<?php endif; ?> 
				...
				<form  action="<?php echo site_url('staff/approve_elective'); ?>" method="get">
					<div class="row">
						...
						<div class="col-sm-3">
							...
							<div class="col-sm-4">
							<label for="year" class="control-label">Approve Electives for Students</label>
								<?php
				...
				<hr/>
				<form  action="<?php echo site_url('staff/approve_elective'); ?>" method="post">
				...
				<input type="hidden" name="specialization" value="<?php echo $_REQUEST['specialization'];  ?>" />
					...
					<div class="row" >
						<div class="row">
							...
							<?php if(@$_REQUEST['search']=='Search' ||  @$_REQUEST['search']=='Save'   ){  ?> 	
								...
								<tr>
									<td><input type="hidden" name="id[]" value="<?php  echo $stu['id']; ?>" /><?php echo $key+1; ?></td>
								...
								if($jso['specialisationCode']==$_REQUEST['specialization']){    ?>
										...
										<?php 	 foreach($jso['ElectiveSubject'] as $key=>$display){ ?>
											...
											?>
													...
													<td align="center">
													<input type="checkbox" name="elective[<?php echo $stu['id'] ?>][approvedelective<?php echo ($elect+1) ?>]" <?php echo $checked; ?>   value="<?php echo $display_res['Code']; ?>"></td>
								<?php } } }} ?>
