...
<div id="content-wrapper" class="wrapper_bg_img">
	...
	<div class="wrapper">
		<div class="container">
			...
			<form class="svt_form" id="alumini_registration" method="POST" action="<?php echo base_url() ?>Alumini/alumini_payment" enctype="multipart/form-data" autocomplete="off">
				<div class="card"> 
					...
					<div class="card-body">
						...
						<input type="hidden" id="fees_amount" name="fees_amount" value="500">
						<input type="hidden" id="online_amount" name="online_amount" value="13.00">
						<input type="hidden" id="total_amount" name="total_amount" value="513.00"> 
						<div class="row">
