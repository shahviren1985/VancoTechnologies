		...
		<div class="card-body">
			...
			<?php echo form_open('officeadmin/leaving-certificate/add/',array('id' => 'leavecertificateform','target' => '_blank'));?>
				<div class="row">					
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="caste" class="control-label">Caste and Sub-Caste</label>
										<select name="caste" id="caste" class="form-control">
											<option value="">Select</option>
											<option value="EWS" <?php echo($student['caste'] == 'EWS') ? 'selected="selected"': '';?>>EWS (Economically Weaker Section)</option>
											<option value="NT1" <?php echo($student['caste'] == 'NT1') ? 'selected="selected"': '';?>>NT (1)</option>
											<option value="NT2" <?php echo($student['caste'] == 'NT2') ? 'selected="selected"': '';?>>NT (2)</option>
											<option value="NT3" <?php echo($student['caste'] == 'NT3') ? 'selected="selected"': '';?>>NT (3)</option>
											<option value="OBC" <?php echo($student['caste'] == 'OBC') ? 'selected="selected"': '';?>>OBC</option>
											<option value="SBC" <?php echo($student['caste'] == 'SBC') ? 'selected="selected"': '';?>>SBC</option>
											<option value="SC" <?php echo($student['caste'] == 'SC') ? 'selected="selected"': '';?>>SC</option>
											<option value="SEBC" <?php echo($student['caste'] == 'SEBC') ? 'selected="selected"': '';?>>SEBC (Socially &amp; Educationally Backward Class)</option>
											<option value="ST" <?php echo($student['caste'] == 'ST') ? 'selected="selected"': '';?>>ST</option>
											<option value="VJ" <?php echo($student['caste'] == 'VJ') ? 'selected="selected"': '';?>>VJ</option>
											<option value="Open" <?php echo($student['caste'] == 'Open') ? 'selected="selected"': '';?>>OPEN</option>
										</select>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" name="sub_caste" id="sub_caste" class="form-control" placeholder="Sub Caste" value="<?php if(isset( $student['sub_caste'])){echo $student['sub_caste'];}else{ } ?>">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label for="religion" class="control-label">Religion</label>
										<select name="religion" id="religion" class="form-control">
											<option value="">Select</option>
											<option value="Buddhist" <?php echo($student['religion'] == 'Buddhist') ? 'selected="selected"': '';?>>Buddhist</option>
											<option value="Christian" <?php echo($student['religion'] == 'Christian') ? 'selected="selected"': '';?>>Christian</option>
											<option value="Hindu" <?php echo($student['religion'] == 'Hindu') ? 'selected="selected"': '';?>>Hindu</option>
											<option value="Jain" <?php echo($student['religion'] == 'Jain') ? 'selected="selected"': '';?>>Jain</option>
											<option value="Muslim" <?php echo($student['religion'] == 'Muslim') ? 'selected="selected"': '';?>>Muslim</option>
											<option value="Other" <?php echo($student['religion'] == 'Other') ? 'selected="selected"': '';?>>Other</option>
											<option value="Parsi" <?php echo($student['religion'] == 'Parsi') ? 'selected="selected"': '';?>>Parsi</option>
											<option value="Sikh" <?php echo($student['religion'] == 'Sikh') ? 'selected="selected"': '';?>>Sikh</option>
										</select>
								</div>
							</div>
							<div class="col-md-6">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" name="nationality" id="nationality" class="form-control" placeholder="Nationality" value="<?php if(isset( $student['nationality'])){echo $student['nationality'];}else{ echo "Indian";} ?>">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" name="date_of_admission" id="date_of_admission" class="form-control" placeholder="Date of Admission" value="<?php if(isset($student['date_of_admission']) && $student['date_of_admission']!=''){echo date('d-m-Y',strtotime(@$student['date_of_admission']));}else { echo "June-".$student['admission_year'];
									}/* echo @$student['date_of_admission'] */ ?>">
								</div>
							</div>
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									if(isset($student['date_of_leaving']) && $student['date_of_leaving']!=''){echo date('d-m-Y',strtotime(@$student['date_of_leaving']));}else {
									}
									?>">
								</div>
							</div>
