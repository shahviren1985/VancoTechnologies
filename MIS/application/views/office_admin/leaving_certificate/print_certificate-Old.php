...
<html lang="en">
	...
	<tr>
				...
				<tr>
					<td style="padding:0 5px">
						...
						<table border="0" width="85%" style="font-size:13px;text-align:left;">
							...
							<tr>
								<td width="35%"><strong>Registration Number</strong></td>
							...
							<tr>
								<td><strong>Caste And Sub-caste</strong></td>
								<td><?php echo " : ". $certificate_data['caste_and_sub_caste']; ?></td>
							</tr>
							<tr>
							...
							<tr>
								<td><strong>Last College Attended</strong></td>
							...
							<tr>
								...
								<td><?php echo " : ". $certificate_data['date_of_leaving']; ?></td>
							</tr>
							<tr>
		...
		<td>
			<table style="text-align:center;width:100%;margin-left:-10px; vertical-align:top;margin-right:-10px; border:2px solid black;">
				<tr>
					<td style="padding:0 5px">
						<table width="95%" style="margin:10px 0;">
							<tr>
						...
						<table border="0" width="85%" style="font-size:13px;text-align:left;">
							...
							<tr>
								<td colspan="2" style="text-align:center;">
									<h6>(No change in any entry in this Certificate shall be made except by the authority issuing it and any infringement of this requirement is liable to involve the imposition of penality such as that of rustication)</h6>
								</td>
							</tr>	
							<tr>
								<td colspan="2" style="text-align:right;">
			...
			<table style="width:100%;margin-left:-10px; vertical-align:top;margin-right:-10px;font-size:13px;">
				<tr>
					<td colspan="3">&nbsp;</td>
				</tr>
				<tr>
