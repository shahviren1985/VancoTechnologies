...
<html lang="en">
	...
	<?php
        ...
        $subject_name = $fees_form_fields['subject_name'] ;
        $semester = $fees_form_fields['semester'] ;
        $credit = $fees_form_fields['credit'] ;
...
<table cellpadding="5" cellspacing ="20" style="text-align:center;width:100%;">
	<tr>
		<td>
				...
				<tr>
					<td style="padding:0 5px">
						...
						<table border="0" width="85%" style="font-size:13px;text-align:left;">
							...
							<tr>
								<td colspan="2" style="text-align:center;">
										<h3 style="font-size:13px">SEMESTER : <?php echo $semester; ?></h3>
								</td>
							</tr>
							<tr>
								<td colspan="2" style="text-align:center;">
										<h3 style="font-size:13px">SUBJECT NAME : <?php echo $subject_name ; ?></h3>
								</td>
							</tr>
							<tr>
								<td colspan="2" style="text-align:center;">
										<h3 style="font-size:13px">SUBJECT CREDITS : <?php echo $credit ; ?></h3>
								</td>
							</tr>
							<tr>
								<td colspan="2" style="text-align:center;">
										<h3 style="font-size:13px">SUBJECT FEES RS. : <?php echo number_format($college_fee,'2') ; ?>/-</h3>
								</td>
							</tr>
							<tr>
								<td colspan="2" style="text-align:center;">
