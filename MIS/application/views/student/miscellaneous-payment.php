				...
				<div class="card-body">
					...
					<div class="row">
						<div class="col-md-4">
							<div class="form-group student_field_radio">
								...
								<span style="margin:0 20px;"></span>
								<label for="master"><input type="radio" name="student_field" id="master" value="master" disabled="disabled"> Masters</label>
							</div>
						</div>
					</div>
					<?php }?>
					...
					<div class="row align-items-end">
						...
						<div class="col-md-4">
							...
							<?php /*<p><a href="https://svt.edu.in/refund-policy.html" target="_blank">Refund Policy</a></p>*/?>
							<p><a href="<?php echo base_url(); ?>miscellaneous-refund-policy" target="_blank">Refund Policy</a></p>
						</div>
					</div>
				</div>
			</div>
...
$(document).ready(function(){
	$('.student_field_radio input[type="radio"]').on('change', function(){
		 if (this.value == 'bachelor') {
			$('#specialisation').html('<option value="">Select Specialisation</option><option value="DC">Developmental Counseling</option><option value="ECCE">Early Childhood Care and Education</option><option value="FND">Food, Nutrition and Dietitics</option><option value="HTM">Hospitality & Tourism Management</option><option value="IDRM">Interior Designing and Resource Management</option><option value="MCE">Mass Communication & Extension</option><option value="TAD">Textile & Apparel Designing</option>');
		}
		else if (this.value == 'master') {
			$('#specialisation').html('<option value="">Select Specialisation</option><option value="DCN">Diabetes & Cardiac Nutrition</option><option value="RN">Renal Nutrition</option><option value="PN">Pediatric Nutrition</option><option value="FD">Fashion Design</option><option value="Regular">Regular</option>');
		}
	});
});
</script>	 