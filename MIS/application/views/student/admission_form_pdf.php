...
$photoData = base64_encode(file_get_contents_by_curl($photo_path));
$photo = 'data:image/'.pathinfo($photo_path, PATHINFO_EXTENSION).';base64,'.$photoData;

$signatureData = base64_encode(file_get_contents_by_curl($signature_path));
$signature = 'data:image/'.pathinfo($signature_path, PATHINFO_EXTENSION).';base64,'.$signatureData;

$parentData = base64_encode(file_get_contents_by_curl($parent_signature));
$parentSignature = 'data:image/'.pathinfo($parent_signature, PATHINFO_EXTENSION).';base64,'.$parentData;
                        ...
                        <td>
                        	 	...
                        	 	<tr>
                            		<td class="" style="width: 80%; font-weight: bold; font-size: 35px;">
                            			<table cellpadding="0" cellspacing="0" style="width: 100%; padding: 0px;">
                                    		<tr>
                                                <td class="borderTable" style="width: 40%; font-weight: bold; font-size: 35px; padding: 15px;">Stream</td>
                                                <td class="borderTable" style="width: 60%; font-size: 35px; padding: 15px;" colspan="3"><?php echo $specialization;  ?></td>
                                            </tr>
                                            <tr>
                                                <td class="borderTable" style="width: 40%; font-weight: bold; font-size: 35px; padding: 15px;">Choice of subject For Std. <?php echo $division; ?></td>
                            		...
                            		<td class="borderTable" style="width: 20%; font-weight: bold; font-size: 35px;">
                            			<table cellpadding="0" cellspacing="0" style="width: 100%;">
                            				<tr>
                            					<td style="text-align: center;"><img src="<?php echo $photo; ?>" width="350" height="280"></td>
                            				</tr>
                            			</table>
                            		</td>
                            	</tr>
                            ...
                            <table cellpadding="0" cellspacing="0" autosize="1" style="width:100%;" class="borderTable">
                                ...
                                <tr>
                                    ...
                                    <td class="borderTable" style="width: 40%; font-size: 35px; padding: 15px;" colspan="3"><?php echo strtoupper($caste_category); ?></td>
                                </tr>
                                <?php if($caste_category == 'General'){
                                	?>
                                <tr>
                                    <td class="borderTable" style="width: 60%; font-weight: bold; font-size: 35px; padding: 15px;">Sub Category:</td>
                                    <td class="borderTable" style="width: 40%; font-size: 35px; padding: 15px;" colspan="3"><?php echo $sub_caste; ?></td>
                                </tr>
                                <?php if (strpos($sub_caste, 'Handicapped') !== false) {
                                	?>
									  <tr>
                            	...
                            	<?php if($caste_category == 'Reservation'){
                                	?>
                                <tr>
                                    <td class="borderTable" style="width: 60%; font-weight: bold; font-size: 35px; padding: 15px;">Sub Category:</td>
                                    <td class="borderTable" style="width: 40%; font-size: 35px; padding: 15px;" colspan="3"><?php echo $sub_caste; ?></td>
                                ...
                                <?php if (strpos($sub_caste, 'Handicapped') !== false) {
									...
									?>
									<?php if (strpos($sub_caste, 'Caste') !== false) {
                                	?>
									  <tr>
                                    ...
                                    <td style="width: 50%; padding: 30px 10px 30px 0px; border-top: 1px solid #000; border-right: 1px solid #000; border-bottom: 1px solid #000;">
                                        ...
                                        <table  cellpadding="0" cellspacing="0" class="borderTable" style="width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <td class="borderTable" style="width: 40%; font-size: 35px; padding: 15px;"><?php echo date('d-m-Y', strtotime($date_of_birth)); ?></td>
                                            </tr>
                                            <tr>
                                    ...
                                    <td colspan="2">
                                        <table cellpadding="0" cellspacing="0" style="width:100%;">
                                            <tr>
                                                ...
                                                <td style="width: 10%; font-size: 35px; padding: 15px;"><?php echo date('d/m/Y'); ?></td>
                                                <td style="width: 10%; font-size: 35px; padding: 15px; font-weight: bold;">Signature:</td>
                                                <td style="width: 20%; font-size: 35px; padding: 15px;"><div style="display:block;text-align:center;"><img src="<?php echo $signature; ?>" style="display:block;width:450px;height:150px;margin:0 auto;"></div>____________________</td>
                                                <td style="width: 30%; font-size: 35px; padding: 15px; font-weight: bold;">Signature of parent/guardian:</td>
                                                <td style="width: 20%; font-size: 35px; padding: 15px;"><div style="display:block;text-align:center;"><img src="<?php echo $parentSignature; ?>" style="display:block;width:450px;height:150px;margin:0 auto;"></div>____________________</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
