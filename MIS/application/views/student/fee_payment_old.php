...
<div id="content-wrapper">
    ...
    <div class="mb-20">    
			...
			<div class="col-md-12">
				<table class="table">
					...
					<tfoot class="aliceblue">
						...
						<tr>
							<td></td>
							<td>GST (18% on online payment processing charges)</td>
						...
						<tr>
							<td></td>
							<th>Grand Total - <?php number_format($gst, '2')?></th>
							<th>₹ <?php $gst = (18/100)*($pay_percentage);
							$grand_total = $fee_head_total+$pay_percentage+number_format($gst, '2');
        ...
        <input type="hidden" name="commission" value="<?php echo number_format($pay_percentage+number_format((18/100)*($pay_percentage), '2'), '2'); ?>">
        <button type="submit" class="btn btn-success">Make Payment</button>
      </form>
    </div>
  </div>
