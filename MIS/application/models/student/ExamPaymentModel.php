...
class ExamPaymentModel extends CI_Model {
	...
	public function insert_transaction_FY($data,$databaseName) {
		$database = '';
 	...
 	public function fetch_course_detail_FY($id,$databaseName) {
		$database = '';
		if(empty($databaseName)){
			$connectionString = 'clg_db2';
		}else{
 	...
 	public function get_transaction_FY($transaction_ref_number,$databaseName){
        $database = '';
        if(empty($databaseName)){
			$connectionString = 'clg_db2';
		}else{
    ...
    public function get_fees_FY($course_id,$databaseName) {
    	$database = '';
        $database = '';
        if(empty($databaseName)){
			$connectionString = 'clg_db2';
