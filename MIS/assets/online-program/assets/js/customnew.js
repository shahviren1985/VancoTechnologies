$(document).ready(function ()
{
    ...
    if (selectedcourse == 3 || selectedcourse == 4)
    {
		...
		$('#BachelorYearofPassing').removeClass("{required:true,messages:{required:'required field'}}");
		$('#BachelorSchoolName').removeClass("{required:true,messages:{required:'required field'}}");
		$('#BachelorMedium').removeClass("{required:true,messages:{required:'required field'}}");
		$('#BachelorBoardName').removeClass("{required:true,messages:{required:'required field'}}");
		//alert("sd");
    ...
    if (selectedcourse == 1 || selectedcourse == 2)
    {
		...
		$('#BachelorYearofPassing').addClass("{required:true,messages:{required:'required field'}}");
		$('#BachelorSchoolName').addClass("{required:true,messages:{required:'required field'}}");
		$('#BachelorMedium').addClass("{required:true,messages:{required:'required field'}}");
		$('#BachelorBoardName').addClass("{required:true,messages:{required:'required field'}}");
	...
	$("#eSuvidha").change(function ()
    {
       checkpdffile("eSuvidha", 2048);
    });
    ...
    $('#admissionFormData').validate(
            {
                rules:
                        {
                            ...
                            GPA4: "required",
                            //GPA5: "required",
                            BachelorYearofPassing: {speicalChar: true},
                            BachelorSchoolName: {speicalChar: true},
                            BachelorMedium: {speicalChar: true},
                            BachelorBoardName: {speicalChar: true},
                ...
                submitHandler: function (form)
                {
                    $.ajax({
                        ...
                        {
                            var msg = 'Your Application is saved successfully. Your application form ID is : ' + response.ApplicationID;
                            alert(msg);
                            if (response.status == 1) {
                                var url = 'https://svt.vancotech.com/selffinance/documents.php?id=' + response.urlD;
                                // console.log(url);
