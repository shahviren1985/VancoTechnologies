...
namespace WebApplication.Admin
{
    public partial class Dashboard : System.Web.UI.Page
    {
        ...
        protected void btnFilter_Click(object sender, EventArgs e)
        {
            ...
            {
                DocumentDetailsDAO ddd = new DocumentDetailsDAO();
                List<DocumentDetails> ddList = ddd.SelectPaperList(ddlCourse.SelectedItem.Text, ddlSubject.SelectedItem.Text, ddlPaper.SelectedItem.Text, mainConnString, logPath);
                gvPaper.DataSource = ddList;
                gvPaper.DataBind();
            //    return ddList;
