...
public partial class Login1 : PageBase
{
    ...
    protected void Login1_Authenticate(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                UserLogins userLoginDetails = new UserLoginsDAO().GetUserLoginByUserNamePassword(txtUserName.Value, txtPassword.Value, "");
                ...
                if (userLoginDetails != null)
                {
                    ...
                    {
                        errorSummary.InnerHtml = "Invalid username and password";
                        errorSummary.Visible = true;
                    }
                }
                else
