<%@ Page Title="MOOC Academy" Language="C#" MasterPageFile="~/Master/ViewMasterPage.master"
    AutoEventWireup="true" CodeFile="HintPage.aspx.cs" Inherits="HintPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            if (chapterId == undefined || sectionId == undefined) {
