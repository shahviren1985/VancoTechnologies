...
public partial class Admin_StudentNotStartedCourse : PageBase
{
    string logPath;
    string cnxnString;
    string configPath;
    ...
    protected void btnGenerate_Click(object s, EventArgs e)
    {
        ...
        try
        {
            ...
            List<UserDetails> filteredUsers = new StudentReportManager().GetStudentNotStartedCourse(ddlCourse.SelectedValue, cnxnString, logPath);
    ...
    protected void btnGenerateExcel_Click(object s, EventArgs e)
    {
        try
        {
            if (ViewState["UserList"] != null)
            {
                ...
                string fileName = "Student-havenot-started-report-" + ddlCourse.SelectedValue + "-" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xlsx";
