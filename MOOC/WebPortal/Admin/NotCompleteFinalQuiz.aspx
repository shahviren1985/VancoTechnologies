<%@ Page Title="Not Completed Final Quiz" Language="C#" MasterPageFile="~/Master/AdminMasterPage.master" AutoEventWireup="true" CodeFile="NotCompleteFinalQuiz.aspx.cs" Inherits="Admin_NotCompleteFinalQuiz" %>
        ...
        <asp:GridView ID="gvUserDetails" PageSize="20" runat="server" Visible="true" AllowPaging="false"
            ...
            <Columns>
                <asp:TemplateField HeaderText="Sr#">
                    <ItemTemplate>
                        <asp:Label ID="gvlblId" runat="server" Text='<%#Eval("BatchYear") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Question Attempt">
                    <ItemTemplate>
                        <asp:Label ID="gvlblEmail" CssClass="gridRows" runat="server" Text='<%#Eval("UserType") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
