<%@ Page Title="Batch-wise Student Status Tracking Report" Language="C#" MasterPageFile="~/Master/AdminMasterPage.master"
    AutoEventWireup="true" CodeFile="BatchWiseStudentStatusTrackingReport.aspx.cs"
    Inherits="Admin_BatchWiseStudentStatusTrackingReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="Server">
    ...
    <div style="margin-top: 0%;">
        ...
        <h3>
            Batch-wise Student Status Tracking Report
        </h3>
    </div>
    ...
    <div class="Record">
        ...
        <div class="Column2">
            <asp:DropDownList ID="ddlBatch" runat="server" Width="170px" OnSelectedIndexChanged="ddlBatch_Change"
                AutoPostBack="true">
                <asp:ListItem Value="0" Text="--Select Batch--" Selected="True"></asp:ListItem>
