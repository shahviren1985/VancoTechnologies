<%@ Page Title="Students who haven't started" Language="C#" MasterPageFile="~/Master/AdminMasterPage.master" AutoEventWireup="true" CodeFile="StudentNotStartedCourse.aspx.cs" Inherits="Admin_StudentNotStartedCourse" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="Server">
    <div style="margin-top: 0%;">
        ...
        <h3>
            Student Haven't Started Course Report
        </h3>
    </div>
