<%@ Page Title="Student Completed Course Report" Language="C#" MasterPageFile="~/Master/AdminMasterPage.master"
    AutoEventWireup="true" CodeFile="CompletedCourseStudentsReport.aspx.cs" Inherits="Admin_CompletedCourseStudentsReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="Server">
    <div style="margin-top: 0%;">
        ...
        <h3>
            Student Completed Course Report
        </h3>
    </div>
