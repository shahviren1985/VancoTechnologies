<%@ Page Title="Student Step-wise Progress Report" Language="C#" MasterPageFile="~/Master/AdminMasterPage.master" AutoEventWireup="true" CodeFile="StudentStepwiseProgressReport.aspx.cs" Inherits="Admin_StudentStepwiseProgressReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="Server">
    <div style="margin-top: 0%;">
        ...
        <h3>
            Student Step-wise Progress Report
        </h3>
    </div>
