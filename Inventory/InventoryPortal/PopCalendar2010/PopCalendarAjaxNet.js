    ...
    if (PopCal) {
        ...
        if (PopCal.initialized == 0) {
            if (!PopCalGetById("popupSuperYear")) {
                if (objPopCal.ie) {
                    var sComponents = "<div id='CalendarLoadFilters' style='z-index:230000;position:absolute;top:0px;left:0px;display:none;filter=" + '"' + "alpha() blendTrans()" + '"' + "'></div>"
                    if (objPopCal.ieVersion >= 5.5) {
                        sComponents += "<iframe id='popupOverShadow' src='javascript:false;' scrolling=no frameborder=0 style='position:absolute;left:0px;top:0px;width:0px;height:0px;z-index:250000;display:none;filter:progid:DXImageTransform.Microsoft.Alpha(opacity=0);'></iframe>"
                        sComponents += "<iframe id='popupOverCalendar' src='javascript:false;' scrolling=no frameborder=0 style='position:absolute;left:0px;top:0px;width:0px;height:0px;z-index:260000;display:none;filter:progid:DXImageTransform.Microsoft.Alpha(opacity=0);'></iframe>"
                        sComponents += "<iframe id='popupOverYearMonth' src='javascript:false;' scrolling=no frameborder=0 style='position:absolute;left:0px;top:0px;width:0px;height:0px;z-index:270000;display:none;filter:progid:DXImageTransform.Microsoft.Alpha(opacity=0);'></iframe>"
                    }
            ...
            sCalendar = "<table id='popupSuperHighLight" + _id + "' class='calendarBorder' cellspacing=0 cellpadding=0 ><tr><td style='cursor:default'>"
...
function PopCalUpMonth(l) {
    ...
    PopCal.popupSuperMonth.style.zIndex = 2750000
...
function PopCalUpYear(l) {
    ...
    PopCal.popupSuperYear.style.zIndex = 2750000
