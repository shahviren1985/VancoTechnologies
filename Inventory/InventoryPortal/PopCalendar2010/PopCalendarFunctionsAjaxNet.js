            ...
            if ((!_v.popupOverMessage) && (_PopCal.ie) && (_PopCal.ieVersion >= 5.5)) {
                if (document.body) {
                    if (document.body.insertAdjacentHTML) {
                        document.body.insertAdjacentHTML("afterBegin", "<iframe id='popupOverMessage" + _PopCal.id + "' src='javascript:false;' scrolling=no frameborder=0 style='position:absolute;left:0px;top:0px;width:0px;height:0px;z-index:240000;display:none;filter:progid:DXImageTransform.Microsoft.Alpha(opacity=0);'></iframe>")
