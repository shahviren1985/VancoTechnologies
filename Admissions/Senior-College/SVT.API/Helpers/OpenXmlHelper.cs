...
namespace SVT.API.Helpers
{
    public class OpenXmlHelper
    {
        public bool ExportDataSet(DataTable table, string excelFileName)
        {
            try
            {
                using (var workbook = SpreadsheetDocument.Create(excelFileName, DocumentFormat.OpenXml.SpreadsheetDocumentType.Workbook))
                {
                    ...
                    headerFooter = AddHeader(sheetPart, "C:\\MyWork\\logo.png");
        ...
        private static HeaderFooter AddHeader(WorksheetPart wsp, string imgPath)
        {
            ...
            oddHeader.Text = "&L&\"Verdana,Bold\"&10Item Report";
