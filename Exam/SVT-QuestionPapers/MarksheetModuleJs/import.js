...
function csvToJson(file, fileName) {
    ...
    reader.onload = function (progressEvent) {
        ...
        for (i = 0; i < json.length; i++) {
		    ...
		    var medium = json[i].Medium != null ? json[i].Medium.toUpperCase() : Medium;
...
function SortJSON(marks){
    for (j = 0; j < PaperPerMarksheet; j++) {
        var index = j + 1;
        var key1 = "Code" + index;
        
        marks.sort(function(a, b){
            if (a[j]["Code" + index] < b[j]["Code" + index]) return -1;
