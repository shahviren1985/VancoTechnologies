...
function PrepareTotalRecord(CreditTotal,InternalTotal, ExternalTotal,GrandTotal,GrandGrade){
		var row = "<tr style='height:50px;'>"+
			"<td colspan='2' style='font-size: 16pt;'><b>Total</b></td>" + 
			"<td style='font-size: 12pt;'><b>"+CreditTotal+"</b></td>" + 
			"<td style='font-size: 12pt;'><b>"+InternalTotal+"</b></td>" + 
			"<td style='font-size: 12pt;'><b>"+ExternalTotal+"</b></td>" + 
			"<td style='font-size: 12pt;'><b>"+GrandTotal+"</b></td>" + 
			"<td style='font-size: 12pt;'><b>"+GrandGrade+"</b></td></tr>";
			return row;
}
