function PrepareMarksTable(marks, paperCode, index) {
    ...
    //    paperTitle = paperTitle.substring(0, 100);
	grace = grace == "" ? "-" : grace;
    var row = "<tr><td style='font-size: 11px'><span style='font-size: 16px;'>" + currentPaper + "</span>" + paperCode + "</td>" +
        "<td style='text-align: left; max-width: 200px; font-size: 11px'>" + paperTitle + "</td>" +
        "<td style='font-size: 11px'>" + credits + "</td>" +
        "<td style='font-size: 11px'>" + internal + "</td>" +
        "<td style='font-size: 11px'>" + external + "</td>" +
        "<td style='font-size: 11px'>" + grace + "</td>" +
        "<td style='font-size: 11px'>" + total + "</td>" +
        "<td style='font-size: 11px'>" + grade + "</td>" +
        "<td style='font-size: 11px'>" + parseFloat(gp).toFixed(2) + "</td>" +
        "<td style='font-size: 11px'>" + parseFloat(gpcr).toFixed(2) + "</td></tr>";
...
function CalculateGrade35Old(marksObtained){
	if(marksObtained >= 90 && marksObtained <= 100)
		return "O+";
	if(marksObtained >= 80 && marksObtained < 90)
		return "O";
...
function GetGradePoint35Old(mark){
