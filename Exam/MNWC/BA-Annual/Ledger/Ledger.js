...
function csvToJson(file, fileName) {
    ...
    reader.onload = function (progressEvent) {
        ...
        for (i = CurrentStudentRecord; i < json.length; i++) {
				...
				//var footer = $("<table id='FooterDetails'+i+'' class='FooterDetails'><tr><td align='left' style='text-align: left;' class='footerplace'>PLACE </td><td align='left' style='text-align: left;'>: &nbsp;<span id='Place'> Hrishi</span></td><td align='center' rowspan='2'>PRINCIPAL <br/> MANIBEN NANAVATI WOMEN'S COLLEGE <br/></td><td align='center' rowspan='2'>CONTROLLER OF EXAMINATIONS<BR/>S.N.D.T. WOMEN'S UNIVERSITY</td></tr><tr><td align='left' style='text-align: left;'>DATE </td><td align='left' style='text-align: left;'>: &nbsp;<span id='MarkSheetDate'>Hrishi</span></td></tr><tr><td colspan='4' align='left'  style='text-align: left; font-size:10px;'>Note: PP=Pass, Ex=Exempted, RR=Result Reserved, AB=Absent, FF=Failed, *Indicates current appearance, +Indicates Grace marks given</td></tr></table><footer />");
				
				var footer = $("<table id='FooterDetails'+i+'' class='FooterDetails'><tr><td align='left' style='text-align: left;' class='footerplace'>PLACE </td><td align='left' style='text-align: left;'>: &nbsp;<span id='Place'> Hrishi</span></td><td align='center' rowspan='2'>PRINCIPAL <br/> MANIBEN NANAVATI WOMEN'S COLLEGE <br/> Vile Parle (W), Mumbai</td><td align='center' rowspan='2'>DIRECTOR <BR />BOARD OF EXAMINATIONS AND EVALUATION<BR/>S.N.D.T. WOMEN'S UNIVERSITY</td></tr><tr><td align='left' style='text-align: left;'>DATE </td><td align='left' style='text-align: left;'>: &nbsp;<span id='MarkSheetDate'>Hrishi</span></td></tr><tr><td colspan='4' align='left'  style='text-align: left; font-size:10px;'>Note: PP=Pass, Ex=Exempted, RR=Result Reserved, AB=Absent, FF=Failed, *Indicates current appearance, +Indicates Grace marks given</td></tr></table><footer />");
				...
				Medium = json[i].Medium.toUpperCase();
                //document.title = json[i].SeatNumber + "-" + json[i].LastName.toUpperCase() + " " + json[i].FirstName.toUpperCase();
                var studentRecordHeader = "<div id='StudentRecord'><div class='sname'><span>NAME:</span><div id='StudentName'>" + studentName + "</div></div><div class='pdetails'><span></span><div id='PerRegNumber'>" + PRN + "</div></div><div class='mdetails'><span>MEDIUM:</span><div id='Medium'>" + Medium + "</div></div><div class='cdetails'><span>CENTRE CODE:</span><div id='CenterName'  style='width: 150px'>" + Center + "</div></div><div class='idetails'><span>INSTITUTION:</span><div id='Institution'>" + Institution + "</div></div><div class='sdetails'><span>SEAT NO:</span><div id='SeatNumber'>" + seatNumber + "</div></div></div>";
                ...
                var studentMarksHeader = "<div class='markswrapper'><div class='studentmarkstable'><table class='markstable'><thead><tr><td width='5%;'>Subject Code</td><td width='50%;'>Subject</td><td width='5%;'>Credits</td><td width='7%;'>Internal Marks (25)</td><td width='7%;'>External Marks (75)</td><td width='5%;'>Grace</td><td width='7%;'>Total Marks (100)</td><td width='5%;'>Grade</td><td width='5%;'>GP</td><td width='5%;'>GP X CR</td></tr></thead><tbody>";

                //json[i] = GetSortOrder(json[i]);
                ...
                var GGP = GrandGPCR / GrandCredit;
                GGP = Math.round(GGP * 100)/100;
                ...
                */
                ...
                studentMarksHeader = studentMarksHeader + "<tr class='TotalRecord'><td colspan='2'>Total</td><td>" + json[i].TotalCredits + "</td><td>" + GrandInternal + "</td><td>" + GrandExternal + "</td><td>" + GrandGrace + "</td><td>" + GrandTotal + "</td><td>" + GrandGrade + "</td><td>" + GrandGP + "</td><td>" + GrandGPCR.toFixed(2) + "</td></tr></tbody></table></div>"
                ...
                studentMarksHeader = studentMarksHeader + "<div class='summarydiv'><table id='ResultSummary'><tr><td width='50%'>TOTAL CREDITS</td><td>: " + GrandCredit + "</td></tr><tr><td width='50%'>GPA</td><td>: " + GGP + "</td></tr><tr><td width='50%'>GRADE</td><td>: " + GrandGrade + "</td></tr><tr><td width='50%'>TOTAL MARKS</td><td>: " + GrandTotal + "</td></tr><tr><td width='50%'>PERCENTAGE</td><td>: " + percent + "%</td></tr><tr><td width='50%'>RESULT</td><td>: " + GrandResult + "</td></tr><tr><td>To Appear In (Sub code) :</td></tr><tr><td colspan='2'>"+GrandPaperAppear+"</td></tr></table></div></div>";
