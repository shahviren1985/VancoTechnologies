...
function PrepareCollegeDetails(){
	//
	var div = "<div style='padding-bottom: 10px; border-bottom: 4px solid royalblue;'><img src='sndt-logo.png' /><span class='sndtnaac'>NAAC Reaccredited</span><div class='h1'>MANIBEN NANAVATI WOMEN'S COLLEGE</div><div class='h5' style='padding-left: 20px;'>VALLABHBHAI ROAD, VILE PARLE (WEST), MUMBAI.</div><div class='h3'>AFFILIATED TO</div><div class='h1 uni'>SHREEMATI NATHIBAI DAMODAR THACKERSEY</br>WOMEN'S UNIVERSITY, MUMBAI</div><img class='collegelogo' src='college-logo.png' /></div>";
	$("#CollegeDetails").append(div);
