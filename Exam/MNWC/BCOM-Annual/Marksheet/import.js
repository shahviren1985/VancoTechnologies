...
function csvToJson(file, fileName) {
    ...
    reader.onload = function (progressEvent) {
        ...
        for (i = 0; i < json.length; i++) {
            ...
            $(commonTable).find("#GrandTotal").html("<b>First Class</b>");
