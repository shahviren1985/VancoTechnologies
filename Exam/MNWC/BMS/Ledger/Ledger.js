    ...
    reader.onload = function (progressEvent) {
        ...
        for (i = CurrentStudentRecord; i < json.length; i++) {
                ...
                */
				...
				//var GrandGPCR = GrandGP * GrandCredit;
                ...
                studentMarksHeader = studentMarksHeader + "<tr class='TotalRecord'><td colspan='2'>Total</td><td>" + json[i].TotalCredits + "</td><td>" + GrandInternal + "</td><td>" + GrandExternal + "</td><td>" + GrandGrace + "</td><td>" + GrandTotal + "</td><td>" + GrandGrade + "</td><td>" + GrandGP + "</td><td>" + GrandGPCR + "</td></tr></tbody></table></div>"
                ...
                studentMarksHeader = studentMarksHeader + "<div class='summarydiv'><table id='ResultSummary'><tr><td width='50%'>TOTAL CREDITS</td><td>: " + GrandCredit + "</td></tr><tr><td width='50%'>GPA</td><td>: " +  parseFloat(GrandGPCR/20).toFixed(2) + "</td></tr><tr><td width='50%'>GRADE</td><td>: " + GrandGrade + "</td></tr><tr><td width='50%'>TOTAL MARKS</td><td>: " + GrandTotal + "</td></tr><tr><td width='50%'>PERCENTAGE</td><td>: " + percent + "%</td></tr><tr><td width='50%'>RESULT</td><td>: " + GrandResult + "</td></tr><tr><td>To Appear In (Sub code) :</td></tr><tr><td colspan='2'>"+GrandPaperAppear+"</td></tr></table></div></div>";
