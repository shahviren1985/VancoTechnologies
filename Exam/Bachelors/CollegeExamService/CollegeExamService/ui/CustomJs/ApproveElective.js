    ...
    CallAPI('Attendance/GetStudentElectives?specialisation=' + specialization + '&semester=' + sem + '&year=' + year, 'GET', '').done(function (data) {
        ...
        for (i = 0; i < data.length; i++) {
            ...
            for (j = 0; j < papers.length; j++) {
                var electivePresent = data[i]["elective1"] == papers[j] || data[i]["elective2"] == papers[j] || data[i]["elective3"] == papers[j] || data[i]["elective4"] == papers[j] || data[i]["elective5"] == papers[j] || data[i]["elective6"] == papers[j];
...
function ApproveElectives(element) {
    ...
    $("#electives").find("tr").each(function () {
        var code1 = $(this).find("td:nth-child(3) input").attr('code');
        var code2 = $(this).find("td:nth-child(4) input").attr('code');
        var code3 = $(this).find("td:nth-child(5) input").attr('code');
        var code4 = $(this).find("td:nth-child(6) input").attr('code');
        var code5 = $(this).find("td:nth-child(7) input").attr('code');
        var code6 = $(this).find("td:nth-child(8) input").attr('code');
        var code7 = $(this).find("td:nth-child(9) input").attr('code');
        ...
        var electives = {
            ...
            "ApprovedElective1": code1 != undefined ? $(this).find("td:nth-child(3) input").prop("checked") == true ? code1 : "" : "",
            "ApprovedElective2": code2 != undefined ? $(this).find("td:nth-child(4) input").prop("checked") == true ? code2 : "" : "",
            "ApprovedElective3": code3 != undefined ? $(this).find("td:nth-child(5) input").prop("checked") == true ? code3 : "" : "",
            "ApprovedElective4": code4 != undefined ? $(this).find("td:nth-child(6) input").prop("checked") == true ? code4 : "" : "",
            "ApprovedElective5": code5 != undefined ? $(this).find("td:nth-child(7) input").prop("checked") == true ? code5 : "" : "",
            "ApprovedElective6": code6 != undefined ? $(this).find("td:nth-child(8) input").prop("checked") == true ? code6 : "" : "",
            "ApprovedElective7": code7 != undefined ? $(this).find("td:nth-child(9) input").prop("checked") == true ? code7 : "" : ""
        };
