...
Examapp.config(function ($routeProvider) {
    $routeProvider
        ...
        .when("/UpdateGE", {
            templateUrl: "View/UpdateGE.html",
            controller: "UpdateGECtrl",
            activetab: "UpdateGE"
        })
        .when("/UploadMarks", {
            templateUrl: "View/UploadMarks.html",
            controller: "UploadMarksCtrl",
        ...
        .when("/ConvocationReport", {
            templateUrl: "View/ConvocationReport.html",
            controller: "ConvocationReportCtrl",
            activetab: "ConvocationReport"
        })
        .when("/YearSetting", {
