...
Examapp.controller("AdvancePaperCtrl", function ($scope, StudentCsvFile) {
    ...
    var CreateFormat = function () {
        $.each($scope.array, function (i, val) {
            ...
            var StudIndex = StudentData.findIndex(x => x.College_Registration_No_ == val.College_Registration_No_);
            if (StudIndex != -1) {
                for (var prop = 0; prop < Object.keys(StudentData[StudIndex]).length; prop++) {
                    ...
                    if (StudentData[StudIndex][_Code] != undefined) {
                        ...
                        StudentData[StudIndex][_PaperAppeared] = "";
                        StudentData[StudIndex][_Code] = "";
                        StudentData[StudIndex][_InternalC] = "";
                        StudentData[StudIndex][_ExternalSection1C] = "";
                        StudentData[StudIndex][_ExternalSection2C] = "";
                        StudentData[StudIndex][_ExternalTotalC] = "";
                        StudentData[StudIndex][_GraceC] = "";
                        StudentData[StudIndex][_PracticalMarksC] = "";
                        StudentData[StudIndex][_Attempt] = "";
                        StudentData[StudIndex][_Remarks] = "";
                    } else {
                        break;
                    }
                }
