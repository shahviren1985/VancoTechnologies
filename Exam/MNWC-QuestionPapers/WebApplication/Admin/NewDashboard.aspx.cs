    ...
    public partial class NewDashboard : System.Web.UI.Page
    {
        ...
        protected List<DocumentDetails> BindGridView()
        {
            try
            {
                ...
                List<DocumentDetails> ddList = ddd.SelectPaperListByAdmin(mainConnString, logPath, true);
        ...
        protected void gvCareerUsers_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "reqDel")
                {
                    ...
                    {
                        List<DocumentDetails> students = commDb.SelectPaperListByAdmin(mainConnString, logPath, true);
                        ...
                        if (students != null)
                        {
                            ...
                            if (student != null)
                            {
                                ...
                                student.IsUsed = "1";
                                commDb.UpdateUsedDocumentDetails(student, mainConnString, logPath);
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                gvStatus.InnerHtml = "Updated the status.";
        ...
        protected void btnFilter_Click(object sender, EventArgs e)
        {
            ...
            {
                DocumentDetailsDAO ddd = new DocumentDetailsDAO();
                List<DocumentDetails> ddList = ddd.SelectNewPaperList(ddlCourse.SelectedItem.Text, ddlSubject.SelectedItem.Text, ddlPaper.SelectedItem.Text, mainConnString, logPath);
                gvPaper.DataSource = ddList;
                gvPaper.DataBind();
            }
            catch (Exception)
