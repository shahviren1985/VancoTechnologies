...
class Report7 extends React.Component {
    render() {
                        ...
                        <table cellPadding={0} cellSpacing={0} className="t1">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td rowSpan={2} className="tr5 td13"><p className="p1 ft7">Internal</p></td>
                                    <td rowSpan={2} className="tr5 td14"><p className="p5 ft0">{row._internal}</p></td>
                                    <td rowSpan={2} className="tr5 td15"><p className="p6 ft7">{row._internal_max}</p></td>
                                </tr>
								<tr>
								...
								<tr>
                                    <td className="tr5 td2"></td>
                                    <td className="tr5 td13"><p className="p1 ft7">Theory</p></td>
                                    <td className="tr5 td14"><p className="p5 ft0">{row._theory}</p></td>
                                    <td className="tr5 td15"><p className="p6 ft7">{row._theory_max}</p></td>
