...
class Report9 extends React.Component {
    render() {
                        ...
                        <table cellPadding={0} cellSpacing={0} className="t1">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td rowSpan={2} className="tr5 td13"><p className="p1 ft7">Written</p></td>
                                    <td rowSpan={2} className="tr5 td14"><p className="p5 ft0">{row._written}</p></td>
                                    <td rowSpan={2} className="tr5 td15"><p className="p6 ft7">{row._written_max}</p></td>
                                </tr>
								<tr>
								...
								<tr>
                                    <td className="tr5 td2"></td>
                                    <td className="tr5 td13"><p className="p1 ft7">General</p></td>
                                    <td className="tr5 td14"><p className="p5 ft0">{row._general}</p></td>
                                    <td className="tr5 td15"><p className="p6 ft7">{row._general_max}</p></td>
                                ...
                                <tr>
									...
									<td className="tr9 td5"><p className="p2 ft1">Grade:</p></td>
                                    <td className="tr9 td6"><p className="p7 ft0">{row._grade}</p></td>
                                </tr>
                                <tr>
