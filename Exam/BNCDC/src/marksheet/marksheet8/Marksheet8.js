...
class Marksheet8 extends React.Component {
                            ...
                            <table cellPadding={0} cellSpacing={0} className="t0">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td className="tr1 td5"><p className="p4 ft2">Practical</p></td>
                                        <td className="tr1 td6"><p className="p8 ft2">{row._practical}</p></td>
                                        <td className="tr1 td7"><p className="p9 ft5">{row._practical_max}</p></td>
                                    </tr>
									<tr>
                                        <td className="tr6 td8"><p className="p3 ft8">&nbsp;</p></td>
                                        <td className="tr6 td9"><p className="p3 ft8">&nbsp;</p></td>
									...
									<tr>
                                        <td className="tr1 td4"><p className="p7 ft2">3.</p></td>
