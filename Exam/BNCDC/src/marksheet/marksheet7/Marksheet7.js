...
import './style.css';
import { getVersion7Data } from '../../util';

class Marksheet7 extends React.Component {
    render() {

        const state = getVersion7Data(this.props.state, this.props.grades);
        return <Fragment>
            {
                        ...
                        <table cellPadding={0} cellSpacing={0} className="t0">
                            <tbody>
                               ...
                               <tr>
                                    ...
                                    <td className="tr12 td10"><p className="p2 ft3">Internal</p></td>
                                    ...
                                    <td className="tr12 td26"><p className="p11 ft4">{row._internal}</p></td>
                                    <td className="tr12 td41"><p className="p0 ft2">&nbsp;</p></td>
                                    <td className="tr12 td27"><p className="p12 ft3">{row._internal_max}</p></td>
                                ...
                                <tr>
								 ...
								 <tr>
                                    <td className="tr6 td32"><p className="p0 ft2">&nbsp;</p></td>
                                    <td className="tr6 td10"><p className="p2 ft3">Theory</p></td>
                                    <td className="tr6 td33"><p className="p0 ft2">&nbsp;</p></td>
                                    <td className="tr6 td34"><p className="p0 ft2">&nbsp;</p></td>
                                    <td className="tr6 td40"><p className="p0 ft2">&nbsp;</p></td>
                                    <td className="tr6 td26"><p className="p11 ft4">{row._theory}</p></td>
                                    <td className="tr6 td41"><p className="p0 ft2">&nbsp;</p></td>
                                    <td className="tr6 td27"><p className="p12 ft3">{row._theory_max}</p></td>
                                    <td className="tr6 td36"><p className="p0 ft2">&nbsp;</p></td>
                                </tr>
                                <tr>
