...
class Marksheet5 extends React.Component {
    render() {
                    ...
                    <div className="page_1" key={index}>
                        ...
                        <table cellPadding={0} cellSpacing={0} className="t0">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td className="tr6 td10"><p className="p2 ft3">Written</p></td>
                                    ...
                                    <td className="tr6 td26"><p className="p11 ft4">{row._written}</p></td>
                                    <td className="tr6 td41"><p className="p0 ft2">&nbsp;</p></td>
                                    <td className="tr6 td27"><p className="p12 ft3">{row._written_max}</p></td>
                                ...
                                <tr>
                                    ...
                                    <td className="tr12 td10"><p className="p2 ft3">Practical</p></td>
                                    ...
                                    <td className="tr12 td26"><p className="p11 ft4">{row._practical}</p></td>
                                    <td className="tr12 td41"><p className="p0 ft2">&nbsp;</p></td>
                                    <td className="tr12 td27"><p className="p12 ft3">{row._practical_max}</p></td>
                                ...
                                <tr>
                                    <td className="tr12 td32"><p className="p0 ft2">&nbsp;</p></td>
                                    <td className="tr12 td10"><p className="p2 ft3">General</p></td>
                                    <td className="tr12 td33"><p className="p0 ft2">&nbsp;</p></td>
                                    <td className="tr12 td34"><p className="p0 ft2">&nbsp;</p></td>
                                    <td className="tr12 td40"><p className="p0 ft2">&nbsp;</p></td>
                                    <td className="tr12 td26"><p className="p11 ft4">{row._general}</p></td>
                                    <td className="tr12 td41"><p className="p0 ft2">&nbsp;</p></td>
                                    <td className="tr12 td27"><p className="p12 ft3">{row._general_max}</p></td>
                                    <td className="tr12 td36"><p className="p0 ft2">&nbsp;</p></td>
                                </tr>
                                <tr>
                                    <td className="tr5 td32"><p className="p0 ft6">&nbsp;</p></td>
                        ...
                        <table cellPadding={0} cellSpacing={0} className="t2">
                            <tbody>
                                ...
                                <tr>
                                    <td className="tr2 td45"><p className="p0 ft3">Date:</p></td>
