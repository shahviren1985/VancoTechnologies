...
namespace Navigettr.Services.Controllers
{
    public class PartnerOffersController : ApiController
    {
        ...
        [HttpPost]
        [HttpOptions]
        [Route("api/offers/getOffers")]
        public HttpResponseMessage getOffers(string city, string country, string latitude, string longitude)
        {
            //var data = _repository.FetchOffers(city, country, latitude, longitude);
            return null;
        }
    }
}
