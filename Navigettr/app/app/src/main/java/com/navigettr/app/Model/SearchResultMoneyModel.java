...
public class SearchResultMoneyModel implements Serializable {

    @SerializedName("TotalCount")
    private int TotalCount;

    @SerializedName("Providers")
    public List<SearchResultMoneyModel.Providers> Providers;
    ...
    public List<SearchResultMoneyModel.Providers> getProviders() {
        return Providers;
    }

    public void setProviders(List<SearchResultMoneyModel.Providers> providers) {
        Providers = providers;
    }
    ...
    public static class Providers implements Serializable {
        ...
        public List<SearchResultMoneyModel.Providers.WorkTime> WorkTime;

        @SerializedName("Offer")
        private SearchResultMoneyModel.Providers.Offer Offer;
        ...
        public List<SearchResultMoneyModel.Providers.WorkTime> getWorkTime() {
            return WorkTime;
        }

        public void setWorkTime(List<SearchResultMoneyModel.Providers.WorkTime> workTime) {
            WorkTime = workTime;
        }

        public SearchResultMoneyModel.Providers.Offer getOffer() {
            return Offer;
        }

        public void setOffer(SearchResultMoneyModel.Providers.Offer offer) {
            Offer = offer;
        }
